/*
Sekundární tabulka s HDP, GINI koeficientem a populací evropských států ve stejném období.
...
-- Nejširší období s dostupnými daty jsou roky 2000 až 2021 (data o mzdách).
