...
-- Vyfiltruji jen kategorii 'cena', zobrazím jen relevantní sloupce, cenu zaokrouhlím.
...
-- Pomocí LIMIT můžu výsledky omezit na první nejnižší meziroční percentuální nárůst.
SELECT
