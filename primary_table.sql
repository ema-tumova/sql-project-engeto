/*
Tabulka pro data mezd a cen potravin za ČR sjednocených na totožné porovnatelné období – společné roky.
Na základě pěti výzkumných otázek a podkladových SQL souborů vytvořím primární tabulku
...
- q2: průměrná mzda a průměrná cena mléka a chleba v letech 2006 a 2018 
...
čímž pod sebe seřadím zvlášť data o cenách a zvlášť o mzdách.
...
-- Když budu porovnávat mzdy a ceny, budu navíc filtrovat záznamy o mzdách
